...
namespace Sfw.Sabp.Mca.Web.Controllers
{
    public partial class PersonController
    {
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string DateofBirthViewModel = "DateofBirthViewModel";
            }
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PersonController : Sfw.Sabp.Mca.Web.Controllers.PersonController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Sfw.Sabp.Mca.Web.ViewModels.CreatePatientViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Sfw.Sabp.Mca.Web.ViewModels.CreatePatientViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Sfw.Sabp.Mca.Web.ViewModels.PatientSearchViewModel viewModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(Sfw.Sabp.Mca.Web.ViewModels.PatientSearchViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Sfw.Sabp.Mca.Web.ViewModels.EditPatientViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Sfw.Sabp.Mca.Web.ViewModels.EditPatientViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
