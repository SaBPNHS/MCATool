...
namespace Sfw.Sabp.Mca.Web.Attributes
{
    ...
    public class AssessmentInProgressActionFilter : ActionFilterAttribute
    {
        #region exception
        ...
        public AssessmentInProgressActionFilter(string actionParameterId, IUserPrincipalProvider userPrincipalProvider, IUserRoleProvider userRoleProvider, IAssessmentHelper assessmentHelper)
        {
    ...
    public class AssessmentInProgressAttribute : Attribute
    {
