...
{
    public partial class BreakPageController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected BreakPageController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public BreakPageController Actions { get { return MVC.BreakPage; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "BreakPage";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "BreakPage";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Views/BreakPage/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_BreakPageController : Sfw.Sabp.Mca.Web.Controllers.BreakPageController
    {
        public T4MVC_BreakPageController() : base(Dummy.Instance) { }
