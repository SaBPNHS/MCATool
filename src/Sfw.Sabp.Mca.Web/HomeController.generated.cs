...
namespace Sfw.Sabp.Mca.Web.Controllers
{
    public partial class HomeController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Tutorial = "~/Views/Home/Tutorial.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : Sfw.Sabp.Mca.Web.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Sfw.Sabp.Mca.Web.ViewModels.DisclaimerViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(Sfw.Sabp.Mca.Web.ViewModels.DisclaimerViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
